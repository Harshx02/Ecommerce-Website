...
class Product(models.Model):
    ...
    pr_item_type = models.CharField(max_length=20, choices=ITEM_TYPE_CHOICES, default="shirts")
    ...
    pr_size = models.CharField(max_length=10, choices=SIZE_CHOICES, default="M")
    pr_color = models.CharField(max_length=30, default="Black")
    ...
    def discount_percentage(self):
        if self.is_on_sale and self.sale_price:
            discount = ((self.pr_price - self.sale_price) / self.pr_price) * 100
